                ...
                <div id='content' style={{marginTop:"30%"}}>
                    ...
                    <div id='menu' className='na' style={{"backgroundColor":'rgba(30,30,30,0.8)',position:"absolute",top:"0px",color:'rgba(240,240,245,0.8)',height:"150px"}}>
                            <div>
                                ...
                                <a href={'/notifications/urgent/'+this.props.user.client_id.toString()} className="ml-2" style={{display:"inline",color:'rgba(240,240,245,0.8)'}}>Urgent</a>
                                <hr />
                            </div>
                            <div>
                                <span style={{display:"inline",fontSize:"18px"}} className='ml-2'>2.</span>
                                <a href={'/notifications/new/'+this.props.user.client_id} className="ml-2" style={{display:"inline",color:'rgba(240,240,245,0.8)'}}>Add New Project</a>
                            </div>
